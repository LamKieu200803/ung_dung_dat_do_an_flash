...
<View>
    ...
    return (
        ...
        <View style={styles.bagach}>
            ...
            <View>
                <Text style={styles.chu2} onPress={() => { props.navigation.navigate('Thongtin') }}>Cập nhật thông tin</Text>
                <View style={{ flexDirection: 'row', marginTop:20, marginLeft:20 }}>
...
<View>
                   <Text style={styles.gmail}>Email: {loginInfo.email}</Text>
                   <Text style={styles.ten}>Tên người dùng: {loginInfo.tennguoimua}</Text>
                   <Text style={styles.ten} >Phone: {loginInfo.phone}</Text>
